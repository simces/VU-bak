...
const PhotoDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('Photo Details:', photoDetailsData);
  ...
  const toggleMapModal = () => {
    console.log('Toggling map modal:', !isMapModalOpen);
  ...
  return (
    <div>
      ...
      {photoDetails.photo.location && (
        <p>
          Location: <button onClick={toggleMapModal} style={{ background: 'none', color: 'blue', border: 'none', padding: 0, cursor: 'pointer' }}>
            {photoDetails.photo.location}
          </button>
        </p>
      )}
      ...
      <LocationMapModal
        ...
        latitude={photoDetails.photo.latitude}
        longitude={photoDetails.photo.longitude}
        location={photoDetails.photo.location}
      />
