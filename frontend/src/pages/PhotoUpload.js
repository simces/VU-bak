...
const PhotoUpload = () => {
  ...
  const [mapCenter, setMapCenter] = useState({ lat: 54.729739260122955, lng: 25.263529812055516 });
  ...
  const handleSubmit = async (e) => {
    ...
    if (latitude !== null && longitude !== null) {
      const confirm = window.confirm("Users will be able to see your tagged location. Are you sure you want to share it?");
      if (!confirm) {
        setLatitude(null);
        setLongitude(null);
